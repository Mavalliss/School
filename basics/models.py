...
class News(models.Model):
    ...
    photo = models.ImageField('Картинка', blank=True)  # Сделать больше прикрепляемых фото!
    ...
    # file = models.FileField('Файлы', blank=True)  # Не мигрировали (возможно нужно будет что-то ещё для файлов!
